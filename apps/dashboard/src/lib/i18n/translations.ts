export const translations: Record<string, Record<string, string>> = {
  ...
  fr: {
    // ── nav ─────────────────────────────────────────────────────────
    'nav.overview': "Vue d'ensemble", 'nav.server': 'Serveur', 'nav.projects': 'Projets', 'nav.applications': 'Applications', 'nav.domains': 'Domaines', 'nav.docker': 'Docker', 'nav.databases': 'Bases de données', 'nav.monitoring': 'Monitoring', 'nav.backups': 'Sauvegardes', 'nav.marketplace': 'Marketplace', 'nav.emails': 'Emails', 'nav.files': 'Fichiers', 'nav.sftp': 'SFTP', 'nav.terminal': 'Terminal', 'nav.settings': 'Paramètres', 'nav.admin': 'Admin', 'nav.toggleTheme': 'Changer le thème',
